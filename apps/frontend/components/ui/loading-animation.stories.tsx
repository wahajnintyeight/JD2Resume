...
export function DefaultSpinner() {
  return <LoadingAnimation message="Loading data..." variant="default" size="md" />;
}

// Example 2: Sparkle variant (recommended for important loading states)
export function SparkleLoader() {
  return <LoadingAnimation message="Checking system status..." variant="sparkle" size="lg" />;
}

// Example 3: Pulse variant (good for background operations)
export function PulseLoader() {
  return <LoadingAnimation message="Syncing..." variant="pulse" size="md" />;
}

// Example 4: Dots variant (minimal, good for inline loading)
export function DotsLoader() {
  return <LoadingAnimation message="Processing..." variant="dots" size="sm" />;
}

// Example 5: Full-screen overlay (for page transitions)
export function FullScreenLoader() {
  return <LoadingOverlay message="Loading your workspace..." variant="sparkle" />;
}
...
export function SectionLoader() {
  return (
    <div className="bg-white rounded-3xl border border-slate-200 p-8">
      <LoadingSection message="Loading content..." variant="dots" />
    </div>
  );
}
...
export function MinimalLoader() {
  return <LoadingAnimation variant="sparkle" size="md" />;
}
